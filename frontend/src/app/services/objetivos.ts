...
export class ObjetivosService {
  private apiUrl = 'http://localhost:8000/backend/controlador/objetivos.php';
  ...
  filtrarIdCliente(id_cliente: number): Observable<any> {
    return this.http.get(`${this.apiUrl}?id_cliente=${id_cliente}`);
  }
