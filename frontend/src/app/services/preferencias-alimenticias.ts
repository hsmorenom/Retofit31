...
export class Preferencias_alimenticiasService {
  private apiUrl = 'http://localhost:8000/backend/controlador/preferencias-alimenticias.php';
  ...
  filtrarIdCliente(id: number): Observable<any> {
    return this.http.get(`${this.apiUrl}?id_cliente=${id}`);
  }
